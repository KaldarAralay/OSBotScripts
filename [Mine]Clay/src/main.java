...
@ScriptManifest(author = "Sean", logo = "", info ="mines iron" , version = 1.0 , name = "[Mine]Clay bank")
public class main extends Script {
    ...
    public int onLoop() throws InterruptedException {
        ...
        if(!getInventory().isFull()){
            ...
            Entity Rocks = objects.closest(7454);
            if(Rocks != null) {
                if(Rocks.isVisible()) {
                    action();
                    ...
                    Area actionArea = new Area(3182, 3377, 3182, 3377);
