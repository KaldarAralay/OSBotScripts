...
@ScriptManifest(author = "Sean Frazier", logo = "", info = "Cuts Willows anywhere", version = 1.0, name = "[WC]Willows")
public class main extends Script {
        ...
        if (!getInventory().isFull()) {
            ...
            if (object1 != null) {
                if (object1.isVisible()) {
                    ...
                    Area actionArea = new Area(3088, 3229, 3088, 3230);
    ...
    public void onPaint(Graphics g){
        g.setColor(new Color(67, 78, 247));
        g.drawString("Sean Frazier", 100, 100);
        g.drawString("Inventory: " + getInventory(), 100, 120);
    }
