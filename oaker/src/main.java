...
@ScriptManifest(author = "Sean Frazier", logo = "", info = "Automatically cuts oaks anywhere til full inventory. Does not bank", version = 1.0, name = "[WC]Oak")
public class main extends Script {
    ...
    public void onStart() {
        ...
        log("Welcome to Sean's Auto Oaker. Automatically cuts oaks anywhere til full inventory. Does not bank");
