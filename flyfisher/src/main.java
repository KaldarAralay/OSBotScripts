...
@ScriptManifest(author = "Sean Frazier", logo = "", info = "Fly Fishes and automatically banks at Edgeville bank", version = 1.0, name = "[Fishing] (auto bank - Edgeville) Fly-Fisher")
    ...
    public int onLoop() throws InterruptedException {
        ...
        if (!getInventory().isFull()) {
            ...
            if (fishSpot != null) {
                ...
                Area fishArea = new Area(3104, 3429, 3108, 3434);
            ...
            //bank
            Area bankArea = new Area(3092, 3491, 3096, 3496);
            if (bankArea.contains(myPlayer())) {
                Entity bankBooth = objects.closest(6943);

                if (bank.isOpen()) {
                    bank.depositAllExcept(this.baitName, this.rodName);
                } else {
                    if (bankBooth != null) {
